...
task("relayer:add")
    ...
    .addOptionalParam("address", "the address for the tx key, it should be used with vk-hash param")
    .addOptionalParam("vkHash", "the vote key hash, it should be used with address param", undefined)
    .addOptionalParam("txKey", "the address for the tx key, it should be used with voteKey param")
    .addOptionalParam("voteKey", "the address for the tx key, it should be used with txKey param")
