...
export const deploy = async (hre: HardhatRuntimeEnvironment, param: GoatTokenParam) => {
    ...
    for (const item of param.transfers) {
        ...
        console.log("transfer token to", item.to, "amount", hre.ethers.formatEther(amount))
